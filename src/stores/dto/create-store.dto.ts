...
import { IsString, IsEnum, IsOptional, IsUrl, IsEmail, IsBoolean, IsObject, MaxLength, MinLength } from 'class-validator';
import { StoreType, StoreStatus, StoreCategory } from '../entities/store.entity';
