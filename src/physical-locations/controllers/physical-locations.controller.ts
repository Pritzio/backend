...
export class PhysicalLocationsController {
  constructor(
    private readonly physicalLocationsService: PhysicalLocationsService,
  ) {}
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - Location with coordinates already exists',
  })
  @ApiResponse({
    status: 403,
  ...
  async createPhysicalLocation(
    ...
    return this.physicalLocationsService.createPhysicalLocation(
      createPhysicalLocationDto,
      req.user,
    );
  }
  ...
  @Get()
  @ApiOperation({
    summary: 'Get all physical locations with filtering and pagination',
  })
  @ApiResponse({
    status: 200,
    description: 'Physical locations retrieved successfully',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search term for name, description, city, or state',
  })
  @ApiQuery({
    name: 'storeId',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: Boolean,
    description: 'Filter by wheelchair access',
  })
  @ApiQuery({
    name: 'hasPublicTransport',
    required: false,
    type: Boolean,
    description: 'Filter by public transport access',
  })
  @ApiQuery({
    name: 'isOpen24Hours',
    required: false,
  ...
  async getAllPhysicalLocations(
    ...
    return this.physicalLocationsService.getAllPhysicalLocations(
      req.user,
      filter,
      page,
      limit,
  ...
  @ApiOperation({
    summary:
      'Get physical locations for admin management (with additional filters)',
  })
  @ApiResponse({
    status: 200,
    description: 'Admin physical locations retrieved successfully',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @Post('nearby')
  @ApiOperation({
    summary: 'Find nearby physical locations within a specified radius',
  })
  @ApiResponse({
    status: 200,
  ...
  async findNearbyLocations(
    ...
    return this.physicalLocationsService.findNearbyLocations(
      searchDto,
      req.user,
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Physical location retrieved successfully',
  })
  ...
  async updatePhysicalLocation(
    ...
    return this.physicalLocationsService.updatePhysicalLocation(
      id,
      updatePhysicalLocationDto,
      req.user,
    );
  ...
  @ApiResponse({
    status: 200,
    description: 'Physical location status changed successfully',
  })
  @ApiResponse({ status: 404, description: 'Physical location not found' })
  @ApiResponse({
    status: 403,
  ...
  async changeLocationStatus(
    ...
    return this.physicalLocationsService.changeLocationStatus(
      id,
      status,
      req.user,
    );
  ...
  @ApiOperation({
    summary: 'Get price comparison for a location with base price',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiQuery({
    ...
    required: true,
    type: Number,
    description: 'Base price to compare against',
  })
  async getLocationPriceComparison(
    ...
    return this.physicalLocationsService.getLocationPriceComparison(
      id,
      basePrice,
      req.user,
    );
  ...
  @ApiOperation({
    summary: 'Get business hours and availability information for a location',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Get capacity status and recommendations for a location',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request - Capacity tracking not enabled',
  })
  @ApiParam({ name: 'id', description: 'Physical location ID' })
  async getLocationCapacityStatus(
    ...
    return this.physicalLocationsService.getLocationCapacityStatus(
      id,
      req.user,
    );
  }
  ...
  @Get(':id/amenities')
  @ApiOperation({
    summary: 'Get amenities and accessibility information for a location',
  })
  @ApiResponse({
    status: 200,
    description: 'Amenities information retrieved successfully',
  })
  @ApiResponse({ status: 404, description: 'Physical location not found' })
  @ApiParam({ name: 'id', description: 'Physical location ID' })
  ...
  @ApiResponse({
    status: 200,
    description: 'City locations retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Type locations retrieved successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Coordinate search completed successfully',
  })
  @ApiQuery({
    name: 'minLat',
    required: true,
  ...
  async getLocationSummaryStats(@Request() req: any): Promise<{
    ...
    const analytics =
      await this.physicalLocationsService.getPhysicalLocationAnalytics(
        req.user,
      );
